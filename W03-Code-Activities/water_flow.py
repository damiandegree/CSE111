...
EARTH_GRAVITY_ACCELERATION = 9.80665 # (meter / second2)
...
def reynolds_number(hydraulic_diameter, fluid_velocity):
      #TODO: Need to implement
      p = WATER_DENSITY
      hydraulic_diameter = PVC_SCHED80_INNER_DIAMETER
      fluid_velocity = SUPPLY_VELOCITY
      u =DYNAMIC_VISCOSITY_WATER

      return (p*hydraulic_diameter*fluid_velocity)/u
